...
/**
 * The base model implementation for the Employee service. Represents a row in the &quot;yali_Employee&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class EmployeeModelImpl extends BaseModelImpl<Employee>
	 ...
	 */
	public static final String TABLE_NAME = "yali_Employee";
	...
	public static final String TABLE_SQL_CREATE = "create table yali_Employee (empId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,field1 VARCHAR(75) null,field2 BOOLEAN,field3 INTEGER,field4 DATE null,field5 VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table yali_Employee";
	public static final String ORDER_BY_JPQL = " ORDER BY employee.field1 ASC";
	public static final String ORDER_BY_SQL = " ORDER BY yali_Employee.field1 ASC";
	...
	public Object clone() {
		...
		employeeImpl.setField1(getField1());
		employeeImpl.setField2(getField2());
		employeeImpl.setField3(getField3());
		employeeImpl.setField4(getField4());
		employeeImpl.setField5(getField5());
	...
	public void resetOriginalValues() {
		...
		employeeModelImpl._originalField2 = employeeModelImpl._field2;

		employeeModelImpl._setOriginalField2 = false;
	...
	public CacheModel<Employee> toCacheModel() {
		...
		employeeCacheModel.field1 = getField1();

		String field1 = employeeCacheModel.field1;

		if ((field1 != null) && (field1.length() == 0)) {
			employeeCacheModel.field1 = null;
		}

		employeeCacheModel.field2 = getField2();

		employeeCacheModel.field3 = getField3();

		Date field4 = getField4();

		if (field4 != null) {
			employeeCacheModel.field4 = field4.getTime();
		}
		else {
			employeeCacheModel.field4 = Long.MIN_VALUE;
		}

		employeeCacheModel.field5 = getField5();

		String field5 = employeeCacheModel.field5;

		if ((field5 != null) && (field5.length() == 0)) {
			employeeCacheModel.field5 = null;
		}
